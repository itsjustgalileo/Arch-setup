...
alacritty tmux wget clipmenu tree htop neofetch acpi unzip zip unrar arj p7zip ffmpeg openssh inetutils dhcpcd rsync mtools dosfstools xclip shellcheck dex network-manager-applet pulseaudio alsa-utils jack2 libwebp libxext xorg-server xorg-xinit xorg-xrandr xorg-xwininfo arc-gtk-theme i3-wm i3status dmenu xss-lock feh picom imagemagick scrot vim emacs texlive-basic texlive-core texlive-bin texlive-latexextra zathura zathura-pdf-mupdf tesseract-data-eng poppler poppler-glib git github-cli diff-so-fancy git-lfs llvm lldb gdb valgrind cmake ninja clang python3 ipython python-pip python-pipx jupyter-notebook jdk-openjdk rustup go nim gcc-ada ocaml dune coq hoogle doxygen wine wine-mono mingw-w64-binutils mingw-w64-gcc mingw-w64-crt mingw-w64-winpthreads mingw-w64-headers libx11 mesa mesa-utils libglvnd vulkan-icd-loader vulkan-intel vulkan-tools libvirt docker docker-compose otf-latin-modern otf-latinmodern-math noto-fonts noto-fonts-cjk noto-fonts-emoji pcmanfm chromium vlc reaper obs inkscape gimp qt6-multimedia-ffmpeg
