...
sudo pacman -Syyu zsh tmux wget git github-cli pulseaudio pulsemixer xorg-server xorg-xinit xwallpaper xclip pcmanfm clipmenu llvm lldb clang cmake ninja emacs python3 mesa mesa-utils valgrind libglvnd vulkan-icd-loader vulkan-intel vulkan-tools i3-wm i3status dmenu ttf-ibm-plex htop acpi unzip zip openssh rsync gdb qemu qemu-arch-extra libvirt virt-manager dnsmasq bridge-utils chromium picom nasm
